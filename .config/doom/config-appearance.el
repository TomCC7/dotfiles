...
(setq doom-font (font-spec :family "MesloLGS Nerd Font Mono" :size (* 13 GDK_SCALE))
      doom-variable-pitch-font (font-spec :family "monospace") ; inherits `doom-font''s :size
      doom-big-font (font-spec :family "MesloLGS Nerd Font Mono" :size (* 15 GDK_SCALE)))

;; org latex preview size
(after! org (setq org-format-latex-options
                  (plist-put org-format-latex-options :scale (* 0.5 GDK_SCALE))))
;; theme
